...
/**
 * 차수별 **공시(선정)일** — E컨슈머 게시 일자. 근거는 ROUNDS.md §1.
 *
 * 기준기간(위)은 무엇을 보고 뽑았나이고, 이것은 언제부터 착한주유소인가다.
 * 선정 이후 행동을 따질 때는 이 날짜를 쓴다. 둘은 사나흘 차이가 난다.
 */
export const ROUND_ANNOUNCED: Record<string, string> = {
  "1차": "20260331",
  "2차": "20260413",
  "3차": "20260427",
  "4차": "20260511",
